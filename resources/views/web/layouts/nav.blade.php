<nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 d-none d-lg-flex">
    <a href="{{ route('home') }}" class="text-decoration-none d-block d-lg-none">
        <img src="{{ App\Helpers\Image::getMediaUrl(setting(), 'logo') }}" alt="{{ setting('name') ?? '' }}" height="70"
            width="170" loading="lazy">
    </a>
...
<div class="mobile-header d-lg-none d-flex justify-content-between align-items-center px-3 py-2">
    <a href="{{ route('home') }}">
        <img src="{{ App\Helpers\Image::getMediaUrl(setting(), 'logo') }}" class="logo"
            style="max-height: 50px; width: auto;" loading="lazy">
    </a>
