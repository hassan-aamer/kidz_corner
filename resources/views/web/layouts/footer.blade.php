            ...
            <div class="row">
                <div class="col-md-6 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-white mb-2" href="{{ route('products') }}"><i class="fa fa-angle-right mr-2"></i>Shop</a>
    ...
    <div class="row mx-xl-5 py-4 text-white">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left">
                <a class="text-white font-weight-semi-bold" href="{{ route('home') }}">{{ setting('copyrights') ?? '' }}</a>. Powered
                by
