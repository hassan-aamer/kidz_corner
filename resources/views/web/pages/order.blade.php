                    ...
                    <div class="mb-4 p-4"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <input class="form-control @error('full_name') is-invalid @enderror" autocomplete="name"
                                    type="text" required name="full_name" placeholder="Full Name"
                                    value="{{ old('full_name') }}" minlength="3" maxlength="100"
                            ...
                            <div class="col-md-4 form-group">
                                <input class="form-control @error('email') is-invalid @enderror" autocomplete="email"
                                    type="email" name="email" placeholder="E-mail (optional)" value="{{ old('email') }}"
                                    maxlength="255" style="border-radius:8px; border:1px solid #ddd; padding:12px;">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 form-group">
                                <input class="form-control @error('phone') is-invalid @enderror" autocomplete="tel"
                                    type="tel" required name="phone" placeholder="Phone (e.g. 01012345678)"
                                    value="{{ old('phone') }}" minlength="8" maxlength="20" pattern="[\d\s\+\-\(\)]+"
                                    style="border-radius:8px; border:1px solid #ddd; padding:12px;">
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 form-group">
                                <textarea rows="2" autocomplete="street-address"
                                    class="form-control @error('address') is-invalid @enderror" name="address"
                                    placeholder="Full Address: ( Country, City, Street, Building )" required minlength="10"
                                    maxlength="500"
                                    style="border-radius:8px; border:1px solid #ddd; padding:12px;">{{ old('address') }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="instapayBox" class="mt-3 p-3 border rounded bg-light"
                                ...
                                <span class="text-muted small" style="font-style:italic;">
                                    ...
                                    • Please transfer the order amount and send the payment receipt via WhatsApp to
                                    confirm your order.
                                </span>
                            </div>
                        </div>
