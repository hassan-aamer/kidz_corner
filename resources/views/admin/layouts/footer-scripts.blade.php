...
<script src="{{ asset('assets/libs/datatables.net-buttons/js/buttons.flash.min.js') }}" defer></script>
...
<script src="{{ asset('assets/libs/multiselect/js/jquery.multi-select.js') }}" defer></script>
