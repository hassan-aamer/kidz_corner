                                    ...
                                    <tbody>
                                        @if ($result->count())
                                            @foreach ($result as $cities)
                                                <tr id="row-{{ $cities->id ?? '' }}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" name="status"
                                                                id="active-{{ $cities->id }}"
                                                                @if ($cities->active == 1) checked @endif
                                                                data-id="{{ $cities->id }}">
                                                            <label class="form-check-label"
                                                                for="active-{{ $cities->id }}"></label>
                                                        </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-block btn-delete"
                                                            ...
                                                            data-bs-target="#delete{{ $cities->id }}">
                                                ...
                                                <!-- Delete Modal -->
                                                <div class="modal fade" id="delete{{ $cities->id }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myCenterModalLabel">
                                                                    @lang('attributes.delete') : <span
                                                                        class="text-danger">{{ $cities->title }}</span>
                                                                </h4>
